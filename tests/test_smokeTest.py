...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("andreatoreki")
    self.driver.find_element(By.ID, "password").send_keys("heloolajlajl")
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Andrea")
    self.driver.find_element(By.NAME, "lname").send_keys("Toreki")
    self.driver.find_element(By.NAME, "bizname").send_keys("The Morning Amen")
